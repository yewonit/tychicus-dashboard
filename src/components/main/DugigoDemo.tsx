...
const DugigoDemo: React.FC = () => {
  const [activeTab, setActiveTab] = useState<'components' | 'dashboard'>(
    'dashboard'
  );
      ...
      {activeTab === 'dashboard' ? (
        ...
        <div>
          ...
          <Card dugigo hoverable style={{ marginBottom: '24px' }}>
            <h3 style={{ color: 'var(--brand-text)', marginBottom: '16px' }}>
              버튼 컴포넌트
            </h3>
            <div
              style={{
          ...
          >
            <Card dugigo>
              <h4 style={{ color: 'var(--brand-text)', marginBottom: '8px' }}>
                기본 카드
              </h4>
              <p style={{ color: 'var(--text-secondary-dugigo)' }}>
                DUGIGO 기본 카드 스타일입니다.
              </p>
            </Card>
          ...
          <Card dugigo>
            ...
            <Table
              ...
              data={tableData}
              onRowClick={record => alert(`클릭: ${record.name}`)}
            />
          </Card>
          ...
          >
            <div style={{ padding: '16px 0' }}>
              <p
                style={{
                  color: 'var(--text-primary-dugigo)',
                  marginBottom: '16px',
                }}
              >
                이것은 DUGIGO 스타일의 모달입니다. 반투명 오버레이와 블러 효과가
                적용되어 있습니다.
              </p>
              <div
                style={{
